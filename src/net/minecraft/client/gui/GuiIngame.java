...
public class GuiIngame extends Gui {
    ...
    //TODO Modified by Bobby
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        EntityPlayer entityplayer = (EntityPlayer) this.mc.getRenderViewEntity();
        int i = sr.getScaledWidth() / 2;
        int item = entityplayer.inventory.currentItem * 20;
        drawRect(0, sr.scaledHeight - 22, sr.scaledWidth, sr.scaledHeight, 0x64000000);
        drawRect(i - 91 + item, sr.scaledHeight - 22 - 1, 22 + i - 91 + item, sr.scaledHeight - 1, 0x99000000);
        drawHorizontalLine(i - 91 + item, 22 + i - 91 + item, sr.scaledHeight - 22, 0xFFFF00DD);
        drawHorizontalLine(i - 91 + item, 22 + i - 91 + item, sr.scaledHeight - 1, 0xFFFF00DD);
        drawVerticalLine(i - 91 + item, sr.scaledHeight - 22 - 1, sr.scaledHeight - 1, 0xFFFF00DD);
        drawVerticalLine(22 + i - 91 + item, sr.scaledHeight - 22 - 1, sr.scaledHeight - 1, 0xFFFF00DD);
